...
namespace ECS.RVO
{
    ...
    internal struct Vector2x
    {
         ...
         * </param>
         */
        internal Vector2x(Fix64 x, Fix64 y)
        {
            x_ = x;
            y_ = y;
        }
         ...
         */
        public static Fix64 operator *(Vector2 vector1, Vector2 vector2)
        {
            return vector1.X * vector2.X + vector1.y_ * vector2.y_;
        }
         ...
         */
        public static Vector2 operator *(Fix64 scalar, Vector2 vector)
        {
         ...
         * <param name="scalar">The scalar value.</param>
         */
        public static Vector2 operator *(Vector2 vector, Fix64 scalar)
        {
