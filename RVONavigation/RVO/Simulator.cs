...
namespace ECS.RVO
{
    ...
    {                   
         ...
         */
        internal int getAgentMaxNeighbors(int agentNo)
        {
         ...
         */
        internal Fix64 getAgentMaxSpeed(int agentNo)
        {
         ...
         */
        internal Fix64 getAgentNeighborDist(int agentNo)
        {
         ...
         */
        internal int getAgentNumAgentNeighbors(int agentNo)
        {
         ...
         * neighbors is to be retrieved.</param>
         */
        internal int getAgentNumObstacleNeighbors(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        internal int getAgentObstacleNeighbor(int agentNo, int neighborNo)
        {
         ...
         */
        internal Vector2 getAgentPrefVelocity(int agentNo)
        {
         ...
         * retrieved.</param>
         */
        internal Fix64 getAgentRadius(int agentNo)
        {
         ...
         * to be retrieved.</param>
         */
        internal Fix64 getAgentTimeHorizon(int agentNo)
        {
         ...
         */
        internal Fix64 getAgentTimeHorizonObst(int agentNo)
        {
         ...
         */
        internal Vector2 getAgentVelocity(int agentNo)
        {
         ...
         * </param>
         */
        internal void setAgentMaxNeighbors(int agentNo, int maxNeighbors)
        {
         ...
         * non-negative.</param>
         */
        internal void setAgentMaxSpeed(int agentNo, Fix64 maxSpeed)
        {
         ...
         */
        internal void setAgentNeighborDist(int agentNo, Fix64 neighborDist)
        {
         ...
         * position.</param>
         */
        internal void setAgentPosition(int agentNo, Vector2 position)
        {
         ...
         */
        internal void setAgentPrefVelocity(int agentNo, Vector2 prefVelocity)
        {
         ...
         * </param>
         */
        internal void setAgentRadius(int agentNo, Fix64 radius)
        {
         ...
         */
        internal void setAgentTimeHorizon(int agentNo, Fix64 timeHorizon)
        {
         ...
         */
        internal void setAgentTimeHorizonObst(int agentNo, Fix64 timeHorizonObst)
        {
         ...
         * velocity.</param>
         */
        internal void setAgentVelocity(int agentNo, Vector2 velocity)
        {
